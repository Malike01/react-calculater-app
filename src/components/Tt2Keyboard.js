...
function Tt2Keyboard(props) {
  ...
  return (
    <div className='tt2Keyboard'>
       <Input text={number} result={result} />
       <button className='switch-btn-2' onClick={ () => props.handleClick('tt2Keyboard')}>tt2</button> / <button className='switch-btn-2' onClick={ () => props.handleClick('tt1Keyboard')}>tt1</button>
    <div className='calc-wrapper' style={{border: "1px solid green"}}>
       <div className='row'>
